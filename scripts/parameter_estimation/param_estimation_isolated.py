...
# data = np.load('/home/astrodeep/bastien/data/test/galaxies_blended_20191024_0_images.npy')
...
# validation_data = data[2000:2496,1,4:]
...
# validation_labels = new_labels[2000:2496]
...
with strategy.scope():
    ...
    net.compile(optimizer=tf.optimizers.Adam(learning_rate=1e-3), 
                loss=negative_log_likelihood)# , metrics = ['mse', 'acc'])
